  ...
  translations: [
    ...
    },
    {
      ...
      data: {
        title: '',
        overview:
          'Ένα στέλεχος που πάσχει από αϋπνίες βρίσκει τον αληθινό εαυτό του στα "Fight Club", όπου συμμετέχει σε αγώνες πυγμαχίας με γυμνά χέρια. Ο ιδρυτής των "Fight Club", ωστόσο, αποδεικνύεται μια επικίνδυνη προσωπικότητα, που επιδίδεται σε πράξεις τρομοκρατίας ενάντια στην καθεστηκυία τάξη.',
        homepage: '',
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        title: '',
        overview:
          'Jack kjeder seg til han møter Tyler, som mener selvdestruksjon gjør livet verdt å leve. For å introdusere andre menn for de simple gleder ved fysisk vold, danner de den hemmelige Fight Club som blir voldsomt populær. Med Brad Pitt og Edward Norton.',
        homepage: '',
      },
    },
    {
...
export { movieDetails, movieTranslations };
